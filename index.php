...
<head>
    <title>Chess</title>
    <?php
    require_once $_SERVER['DOCUMENT_ROOT'] . '/Chess/elements/head.php';
    require_once $_SERVER['DOCUMENT_ROOT'] . '/Chess/functions.php';
    ?>
</head>
...
<body>
    <div class='container'>
        <?php
        echo '<div class="voltar-container"><a class="voltar" href="Start Page.php"> Leave</a></div>';
